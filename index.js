var verifier = require('cortana-verifier')

// the cortana API calls specify an HTTPS certificate that must be validated.
...
module.exports = function cortanaVerifierMiddleware(req, res, next) {
  if (req._body) {
